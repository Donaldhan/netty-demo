...
import netty.handler.time.TimeClientHandler2;
/**
 * 
 * @author donald
 * 2017年6月21日
...
public final class TimeClient2 {
	private static final Logger log = LoggerFactory.getLogger(TimeClient2.class);
...
//                     pipeline.addLast(new LoggingHandler(LogLevel.INFO));
                     pipeline.addLast(new TimeClientHandler2());
                 }
             });

 ...
 * 下午12:50:46
 */
public class MathClientMultiInitializer extends ChannelInitializer<SocketChannel> {

    private final SslContext sslCtx;

    public MathClientMultiInitializer(SslContext sslCtx) {
        this.sslCtx = sslCtx;
    }
    ...
    public void initChannel(SocketChannel ch) {
        ...
        pipeline.addLast(new MathClientMultiHandler());
    }
}
